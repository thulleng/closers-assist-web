...
const conversations = [
  {
    ...
    bubbles: [
      {
        side: "in" as const,
        text: "bro you gotta try this Closers Assist thing",
      },
      {
        side: "out" as const,
        text: "the ai thing? does it actually work",
      },
      {
        side: "in" as const,
        text: "used it on a $499 RAV4 objection at 8pm",
      },
      {
        side: "in" as const,
  ...
  },
  {
    ...
    bubbles: [
      {
        side: "in" as const,
        text: "my CXI went from 4.7 to 5.0 in 3 weeks",
      },
      {
        side: "in" as const,
  ...
  },
  {
    ...
    bubbles: [
      {
        side: "in" as const,
        text: "told my manager about it",
      },
      {
        side: "in" as const,
        text: "he tried to block it from the store ipad 😂",
      },
      {
        side: "in" as const,
      ...
      <FadeIn>
        <div className="relative mb-8 flex items-center gap-2">
          <div className="flex h-5 w-5 items-center justify-center text-gold-light">
            <svg viewBox="0 0 16 16" width="14" height="14" fill="currentColor" aria-hidden="true"><path d="M2 2h12a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H5l-3 2V3a1 1 0 0 1 1-1z"/></svg>
          </div>
                      ...
                      {bubble.reaction && (
                        <div
                          ...
                          className={`absolute -bottom-2 text-base ${
                            bubble.side === "out" ? "left-0" : "right-0"
                          }`}
                        >
                          {bubble.reaction}
                        </div>
