...
import { ArrowLeft, ShoppingBag, Download, Settings2 } from "lucide-react";
import Dashboard from "@/components/Dashboard";
import { retailDashboardSample } from "@/lib/dashboard-data-retail";

export const metadata: Metadata = {
  title: "Retail Dashboard",
  description:
    "Live sales dashboard for big-ticket retail closers. Tickets, attachment rate, gross profit, SPIFF progress — updated daily.",
};
...
export default function RetailDashboardPage() {
  return (
    <>
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-2">
            <div className="hidden items-center gap-2 sm:flex">
              <ShoppingBag className="h-4 w-4 text-neon-green" strokeWidth={2} />
      ...
      <Dashboard data={retailDashboardSample} />
