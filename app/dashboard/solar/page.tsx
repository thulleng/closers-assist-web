...
import { ArrowLeft, Sun, Download, Settings2 } from "lucide-react";
import Dashboard from "@/components/Dashboard";
import { solarDashboardSample } from "@/lib/dashboard-data-solar";

export const metadata: Metadata = {
  title: "Solar Dashboard",
  description:
    "Live sales dashboard for solar reps. kW sold, install pipeline, clawback risk, volume bonuses — updated daily.",
};
...
export default function SolarDashboardPage() {
  return (
    <>
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4">
          ...
          <div className="flex items-center gap-2">
            <div className="hidden items-center gap-2 sm:flex">
              <Sun className="h-4 w-4 text-neon-green" strokeWidth={2} />
      ...
      <Dashboard data={solarDashboardSample} />
      ...
      <section className="mx-auto max-w-[480px] px-4 pb-20">
        <div className="glass-panel p-5 text-center">
          ...
          <div className="mb-3 text-[15px] text-bone">
            Live preview using sample SunRise Energy data. Real accounts
            auto-generate from your CRM, permit tracker, and pay plan upload.
          </div>
